...
import { ShimmerComponent } from '../../../../components/feedback/shimmer/shimmer';
...
@Component({
  selector: 'ui-multi-selection-field',
  standalone: true,
  imports: [
    BaseInputComponent,
...
export class MultiSelectionFieldComponent<T> extends BaseControlValueAccessor<T[]> implements AfterContentInit {
