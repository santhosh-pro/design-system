...
import { PaginationEvent } from '../../../display/pagination/pagination';
import { TableSortEvent } from '../sortable-table';
import { BaseControlValueAccessor } from '../../../../core/base-control-value-accessor';

@Component({
  selector: 'ui-responsive-data-table',
  standalone: true,
  imports: [CommonModule, DataTable, MobileDataTable],
  templateUrl: './responsive-data-table.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ResponsiveDataTable<T> extends BaseControlValueAccessor<TableStateEvent> {
