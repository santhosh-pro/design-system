...
import { ColumnDef, ColumnNode, DataTable, TableActionEvent, TableStateEvent } from 'projects/ui-lib/src/public-api';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, DataTable, DemoCard, DocIoList],
