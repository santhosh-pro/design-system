...
import { DataTableComponent, ColumnGroup, ColumnDef, TableStateEvent, TableActionEvent, provideNgxMask } from '../../../ui-lib/src/public-api'; // Adjust path as needed
import { TableSortEvent } from 'projects/ui-lib/src/lib/components/data-table/base-table/sortable-table.directive';
import { PaginationEvent } from 'projects/ui-lib/src/lib/components/pagination/pagination.component';
import { AppSvgIconComponent } from 'projects/ui-lib/src/lib/components/app-svg-icon/app-svg-icon.component';
import { NgxMaskDirective } from 'projects/ui-lib/src/lib/components/input-mask/ngx-mask.directive';
@Component({
  selector: 'app-root',
  imports: [
    RouterOutlet,
    DataTableComponent,
    NgxMaskDirective,
    AppSvgIconComponent // Add AppSvgIconComponent
  ],
  providers: [],
